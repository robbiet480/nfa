...
func init() {
	...
	notifyCmd.Flags().StringVarP(&appName, "app-name", "n", "nfa.go", "App name to display the notification as generated by")
	...
	notifyCmd.Flags().StringVarP(&message, "message", "m", "Hello from nfa.go!", "Message to show")
	...
	notifyCmd.Flags().StringVarP(&title, "title", "t", "nfa.go", "Title of notification")
...
func getDefaultImagePath() string {
	...
	return fmt.Sprintf("%s/src/github.com/robbiet480/nfa.go/gopher.png", gopath)
}
